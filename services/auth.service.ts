...
/** Incrémenter pour réinitialiser les PIN / overrides persistés (mock). v2 : reset global → manager par défaut 5678. */
const ACCOUNTS_STORAGE_KEY = "glonetz_auth_accounts_v2"
