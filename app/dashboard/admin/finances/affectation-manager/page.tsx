      ...
      <div className="overflow-hidden rounded-2xl border bg-card shadow-sm">
        ...
        <div className="p-3 sm:p-4">
          ...
          <div className="space-y-2">
            ...
            <label className="block text-xs font-medium text-muted-foreground">{t("fin_alloc_motif")}</label>
            <input value={extraLabel} onChange={(e) => setExtraLabel(e.target.value)} placeholder={t("fin_alloc_extra_motif_ph")} className="min-h-10 w-full rounded-lg border bg-background px-3 py-2 text-sm" />
            <label className="block text-xs font-medium text-muted-foreground">{t("fin_alloc_amount")}</label>
            <input value={extraAmount} onChange={(e) => setExtraAmount(e.target.value)} type="number" placeholder={t("fin_alloc_amount_ph")} className="min-h-10 w-full rounded-lg border bg-background px-3 py-2 text-sm" />
            <button
              onClick={() => {
